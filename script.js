const questions = {
    ...
    "Comparativos de Igualdad y Desigualdad" : {
        easy: [
            { question: "Which sentence is correct? 'She is as tall ___ her brother.'", options: ["than", "like", "of", "as"], answer: 3 },
            { question: "Choose the correct option: 'This book is ___ interesting as that one.'", options: ["like", "as", "so", "more"], answer: 1 },
            { question: "What is the correct answer? 'He runs ___ fast as his friend.'", options: ["than", "less", "as", "more"], answer: 2 },
            { question: "Complete the sentence: 'This car is not ___ expensive as that one.'", options: ["as", "so", "like", "more"], answer: 1 },
            { question: "Choose the correct form: 'She is ___ smart as him.'", options: ["than", "so", "as", "more"], answer: 2 },
            { question: "What is the correct answer? 'He speaks ___ clearly as a teacher.'", options: ["so", "as", "than", "like"], answer: 0 },
            { question: "Select the correct form: 'This game is not ___ exciting as the last one.'", options: ["more", "as", "so", "less"], answer: 2 },
            { question: "Choose the correct option: 'He is as good ___ his brother.'", options: ["than", "so", "like", "as"], answer: 3 },
            { question: "Which is correct? 'This task is ___ difficult as the other one.'", options: ["less", "so", "more", "as"], answer: 3 },
            { question: "Choose the correct form: 'They are as hardworking ___ their parents.'", options: ["as", "than", "so", "more"], answer: 0 },
        ],
        medium: [
            { question: "Complete the sentence: 'Her house is not ___ big as her friend's.'", options: ["as", "so", "more", "than"], answer: 1 },
            { question: "What is the correct option? 'This film is as interesting ___ that one.'", options: ["more", "than", "so", "as"], answer: 3 },
            { question: "Choose the correct answer: 'This road is not ___ dangerous as it looks.'", options: ["as", "so", "more", "less"], answer: 1 },
            { question: "Select the correct form: 'He is not as tall ___ his father.'", options: ["so", "as", "more", "than"], answer: 1 },
            { question: "What is the correct answer? 'The cat is ___ agile as the dog.'", options: ["as", "more", "than", "so"], answer: 0 },
            { question: "Choose the correct option: 'This meal is as tasty ___ the one we had yesterday.'", options: ["more", "as", "like", "so"], answer: 1 },
            { question: "Which is correct? 'Her singing is not ___ good as his.'", options: ["as", "more", "than", "so"], answer: 3 },
            { question: "Complete the sentence: 'This movie is not ___ funny as that comedy show.'", options: ["more", "as", "less", "so"], answer: 3 },
            { question: "Choose the correct option: 'My score is as high ___ his.'", options: ["more", "than", "as", "so"], answer: 2 },
            { question: "What is the correct form? 'The test is ___ challenging as expected.'", options: ["so", "as", "more", "than"], answer: 1 },
        ],
        hard: [
            { question: "Choose the correct sentence: 'She is not as hardworking ___ her colleague.'", options: ["than", "as", "so", "more"], answer: 1 },
            { question: "Select the correct form: 'The new model is as efficient ___ the old one.'", options: ["so", "more", "as", "less"], answer: 2 },
            { question: "Complete the sentence: 'This software is as user-friendly ___ possible.'", options: ["so", "like", "as", "than"], answer: 2 },
            { question: "Which sentence is correct? 'Their house is not ___ modern as ours.'", options: ["more", "so", "than", "as"], answer: 1 },
            { question: "Choose the correct option: 'He is not as talkative ___ his friend.'", options: ["as", "so", "than", "like"], answer: 1 },
            { question: "What is the correct answer? 'This project is as important ___ the previous one.'", options: ["so", "more", "as", "than"], answer: 2 },
            { question: "Choose the correct option: 'Their team is not ___ strong as last year.'", options: ["more", "less", "as", "so"], answer: 3 },
            { question: "Complete the sentence: 'The view here is as beautiful ___ we imagined.'", options: ["as", "so", "more", "like"], answer: 0 },
            { question: "What is the correct answer? 'This task is not ___ easy as it seems.'", options: ["less", "so", "as", "more"], answer: 1 },
